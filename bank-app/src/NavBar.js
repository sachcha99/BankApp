...
const NavBar = ({ user }) => {
  ...
  return (
    <div>
      <AppBar sx={{ bgcolor: "#140149", zIndex: 10000 }} position="static">
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            <AdbIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1, color: '#808080' }} />
            <Typography
              variant="h6"
              noWrap
              component="a"
            ...
            <div style={{}}>
              ...
              <Button onClick={() => { navigate(`/fundTransfer`) }} variant="h6" component="div" sx={{ flexGrow: 1, fontFamily: 'Arial' }}>
